...
import { RoleRepositoryService } from '../../auth/_services/auth-repository/role-repository.service';
import { TypeDocumentRepositoryService } from '../../auth/_services/auth-repository/typedocument-repository.service';
import { catchError } from 'rxjs/operators';
import { of, interval, Subject, Subscription, Observable } from 'rxjs';
import { RolesModel } from '../../auth/_models/Roles.model';
import { TypeDocumentModel } from '../../auth/_models/TypeDocument.model';
import { InternalUser } from '../models/internal-user.model';
import { DepartamentRepositoryService } from '../../auth/_services/auth-repository/departament-repository.service';
import { DepartamentModel } from '../../auth/_models/Departament.model';
import { ProvinceModel } from '../../auth/_models/Province.model';
import { ProvinceRepositoryService } from '../../auth/_services/auth-repository/province-repository.service';
import { DistrictModel } from '../../auth/_models/District.model';
import { DistrictRepositoryService } from '../../auth/_services/auth-repository/distric-repository.service';
import { CcppModel } from '../../auth/_models/Ccpp.model';
import { CcppRepositoryService } from '../../auth/_services/auth-repository/ccpp-repository.service';
import { UserModel } from '../../auth/_models/user.model';
import { UserHTTPServiceDomain } from '../../auth/_services/auth-domain/user-domain.service';
...
export class InternalUserComponent implements OnInit, OnDestroy{
    formGroup: FormGroup;
