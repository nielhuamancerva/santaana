...
import { BeneficiaryHTTPServiceDomain } from '../auth-domain/beneficiary-domain.service';
@Injectable({
  providedIn: 'root',
})
export class BeneficiaryRepositoryService {

    constructor(private _beneficiaryservicedomain: BeneficiaryHTTPServiceDomain) {}
